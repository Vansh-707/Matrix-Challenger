...
let CommentsController = class CommentsController {
    ...
    editComment(id, createCommentDto) {
        return this.commentsService.update(Number(id), createCommentDto);
    }
    deleteComment(id) {
        return this.commentsService.remove(Number(id));
    }
    restoreComment(id) {
        return this.commentsService.restore(Number(id));
    }
};
__decorate([
    common_1.Post(),
...
__decorate([
    common_1.Post(':id/restore'),
    __param(0, common_1.Param('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CommentsController.prototype, "restoreComment", null);
